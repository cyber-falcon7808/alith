...
After contributing your private data and minting a DAT (Data Anchor Token), you can run AI inference on your data in a privacy-preserving way using LazAI. This workflow ensures your sensitive data remains secure and under your control, while still enabling powerful AI capabilities.
...
const node = "0xc3e98E8A9aACFc9ff7578C2F3BA48CA4477Ecf49";
...
// await client.addUser(1000000);

// console.log("added user");
// await client.depositInference(node, 1000000);
console.log("deposited inference");
console.log(

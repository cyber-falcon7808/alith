...
export const IPFS_TRUSTLESS_GATEWAY_LINK: string = 'https://trustless-gateway.link'
...
function PinataFileDetailsToMetadata(pinataFileDetails: PinataFileDetails): FileMetadata {
  return {
